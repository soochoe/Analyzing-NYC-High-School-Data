...
The objective of this project is to examine relationships between Scholastic Aptitude Test (SAT) scores and demographic factors in New York City (NYC) public high schools. The datasets used for this analysis are publicly available on the NYC website: data.cityofnewyork.us.
